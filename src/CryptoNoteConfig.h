...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 109;
...
const char     CRYPTONOTE_NAME[]                             = "Kastala";
...
const int      P2P_DEFAULT_PORT                              =  13281;
const int      RPC_DEFAULT_PORT                              =  13282;
...
const char* const SEED_NODES[] = { "134.255.234.227:13281", "134.255.234.229:13281" };
